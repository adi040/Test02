        ...
        if (params.regulation === '2018') {
            if (params.course === 'theory') {
                inputFields.innerHTML = `
                    ...
                    <input type="number" id="ct1" max="25" min="0" placeholder="Enter below 25" required>
                    <label for="ct2">Cycle Test 2 (50 Marks):</label>
                    <input type="number" id="ct2" max="50" min="0" placeholder="Enter below 50" required>
                    <label for="ct3">Cycle Test 3 (50 Marks):</label>
                    <input type="number" id="ct3" max="50" min="0" placeholder="Enter below 50" required>
                    <label for="ct4">Cycle Test 4 (10 Marks):</label>
                    <input type="number" id="ct4" max="10" min="0" placeholder="Enter below 10" required>
                `;
            } else if (params.course === 'joint') {
                inputFields.innerHTML = `
                    <label for="ct1">Cycle Test 1 (10%):</label>
                    <input type="number" id="ct1" max="10" min="0" placeholder="Enter below 10%" required>
                    <label for="ct2">Cycle Test 2 (15%):</label>
                    <input type="number" id="ct2" max="15" min="0" placeholder="Enter below 15%" required>
                    <label for="ct3">Cycle Test 3 (15%):</label>
                    <input type="number" id="ct3" max="15" min="0" placeholder="Enter below 15%" required>
                    <label for="ct4">Cycle Test 4 (10%):</label>
                    <input type="number" id="ct4" max="10" min="0" placeholder="Enter below 10%" required>
                    <label for="practical-lab">Lab Practical (25%):</label>
                    <input type="number" id="practical-lab" max="25" min="0" placeholder="Enter below 25%" required>
                `;
            }
            ...
            if (params.course === 'theory') {
                inputFields.innerHTML = `
                    ...
                    <input type="number" id="ct1" max="50" min="0" placeholder="Enter below 50" required>
                    <label for="ct2">Cycle Test 2 (50 Marks):</label>
                    <input type="number" id="ct2" max="50" min="0" placeholder="Enter below 50" required>
                `;
            } else if (params.course === 'joint') {
                inputFields.innerHTML = `
                    ...
                    <input type="number" id="ct1" max="30" min="0" placeholder="Enter below 30%" required>
                    <label for="ct2">Cycle Test 2 (30%):</label>
                    <input type="number" id="ct2" max="30" min="0" placeholder="Enter below 30%" required>
                    <label for="practical">Practical (40%):</label>
                    <input type="number" id="practical" max="40" min="0" placeholder="Enter below 40%" required>
                `;
            }
        }
    }
